...
def process_pdf():
    try:
        ...
        try:
            ...
            return jsonify({'success': False, 'error': f'MinerU API初始化失败: {str(e)}'}), 500
        ...
        if not result:
            ...
            return jsonify({'success': False, 'error': 'PDF处理失败，MinerU返回空结果'}), 500
        ...
        return jsonify({'success': False, 'error': f'处理PDF时出错: {str(e)}'}), 500
